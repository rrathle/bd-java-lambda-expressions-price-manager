...
public class PriceManager {
    ...
    public List<BigDecimal> calculateStateTotalPrices(List<BigDecimal> prices, BigDecimal setupFee, BigDecimal
        ...
        return newPriceCalculator.calculateTotalPrices(prices, startingPrice -> startingPrice.add(setupFee).multiply(salesTax));
    }
    ...
    public List<BigDecimal> calculateStateTotalPrices(List<BigDecimal> prices, BigDecimal setupFee, BigDecimal salesFee,
        ...
        return newPriceCalculator.calculateTotalPrices(prices, startingPrice -> startingPrice.add(setupFee).add(countyFee).add(salesFee));
